...
@section('content')
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <label class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="filter" value="0"
                                        checked="">
                                    <span class="form-check-label">Tout</span>
                                </label>
                                <label class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="filter" value="1">
                                    <span class="form-check-label">Manquants</span>
                                </label>
                                <label class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="filter" value="3">
                                    <span class="form-check-label">Doubles</span>
                                </label>
                            </div>
                        </div>
                        <div class="card">
    ...
    <script>
        $(document).ready(function() {
            ...
            const selectedValue = stateParam === '1' ? '1' : stateParam === '3' ? '3' : '0';

            $('input[name="filter"][value="' + selectedValue + '"]').prop('checked', true);
            ...
            $('input[name="filter"]').on('change', function() {
                ...
                url.searchParams.set('state', filterValue);
